...
const t = {
  'en-US': {
    ...
    qiantaiDesc: 'Front desk. Only check-in and reservation permissions.',
  ...
  'zh-CN': {
    ...
    qiantaiDesc: '酒店前台，仅拥有办理入住和预订功能的权限。',
  ...
  'zh-TW': {
    ...
    qiantaiDesc: '酒店前台，僅擁有辦理入住和預訂功能的權限。',
  ...
  'ja-JP': {
    ...
    qiantaiDesc: 'フロントデスク。チェックインと予約の権限のみ。',
  ...
  'ko-KR': {
    ...
    qiantaiDesc: '프론트 데스크. 체크인 및 예약 권한만 있음.',
  ...
  'pt-BR': {
    ...
    qiantaiDesc: 'Recepção. Apenas permissões de check-in e reserva.',
  ...
  'ru-RU': {
    ...
    qiantaiDesc: 'Стойка регистрации. Только права на регистрацию и бронирование.',
  ...
  'es-ES': {
    ...
    qiantaiDesc: 'Recepción. Solo permisos de reserva y check-in.',
  ...
  'fr-FR': {
    ...
    qiantaiDesc: 'Réception. Seulement des droits de réservation et d\'enregistrement.',
  ...
  'de-DE': {
    ...
    qiantaiDesc: 'Rezeption. Nur Berechtigungen für Check-in und Reservierung.',
  ...
  'id-ID': {
    ...
    qiantaiDesc: 'Resepsionis. Hanya izin masuk kamar dan pemesanan.',
  ...
  'vi-VN': {
    ...
    qiantaiDesc: 'Lễ tân. Chỉ có quyền nhận phòng và đặt trước.',
  ...
  'th-TH': {
    ...
    qiantaiDesc: 'แผนกต้อนรับ มีสิทธิ์เฉพาะการจองและเช็คอิน',
...
<body>
  ...
  <main>
    ...
    <div class="features">
      ...
      <div class="card">
        <h3>qiantai (123456)</h3>
        <p>${text.qiantaiDesc}</p>
      </div>
    </div>
